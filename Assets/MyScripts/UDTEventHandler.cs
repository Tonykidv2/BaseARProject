...
public class UDTEventHandler : MonoBehaviour, IUserDefinedTargetEventHandler
{
    ...
    void Start()
    {
        ...
        m_button = GameObject.FindGameObjectWithTag("GameStartButton").GetComponent<Button>();
    ...
    {
        if(m_button.GetComponentInChildren<Text>().text == "Reset")
        {
            SceneManager.LoadScene(SceneManager.GetActiveScene().name);
            return;
            //Destroy(GameObject.FindGameObjectWithTag("CustomImageTarget"));
            //m_button.GetComponentInChildren<Text>().text = "Reset";
            //return;
        }
